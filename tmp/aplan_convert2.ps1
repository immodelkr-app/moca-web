...
function Convert-ToAPlan {
    ...
    if (-not (Test-Path $filePath)) { Write-Host "SKIP (not found): $filePath"; return }
...
Convert-ToAPlan (Join-Path $basePath "src\components\AdminPartners.jsx")
Convert-ToAPlan (Join-Path $basePath "src\components\AdminPopups.jsx")
Convert-ToAPlan (Join-Path $basePath "src\components\AdminShop.jsx")
Convert-ToAPlan (Join-Path $basePath "src\components\AdminContractViewerModal.jsx")
Write-Host "All sub-components converted!"
