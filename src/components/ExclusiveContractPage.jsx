                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-10 mt-10 border-t-2 border-black pt-10">
                        <div className="flex-1">
                            ...
                            <div className="space-y-3 font-medium text-sm">
                                <div className="flex"><span className="w-20 text-gray-500 font-bold">법명/상호:</span> 글로벌아임 (아임모델)</div>
                                <div className="flex"><span className="w-20 text-gray-500 font-bold">대표자:</span> 김 대 희</div>
                                <div className="flex"><span className="w-20 text-gray-500 font-bold">주소:</span> 서울특별시 강남구 논현로 648 (우:06103)</div>
                        ...
                        <div className="flex-1 bg-blue-50/50 p-6 rounded-2xl border border-blue-100 relative shadow-sm">
                            ...
                            <div className="space-y-4 font-medium text-sm">
                                <div className="flex items-center">
                                    <span className="w-24 text-gray-600 font-bold whitespace-nowrap">주민등록번호:</span>
                                ...
                                <div className="flex items-center">
                                    <span className="w-24 text-gray-600 font-bold whitespace-nowrap">법정 주소:</span>
                                    <input type="text" name="memberAddress" value={contractData.memberAddress} onChange={handleInput} placeholder="계약 조항용 주소 입력" className="flex-1 border-b border-gray-400 bg-transparent outline-none px-1" />
                                </div>
                                <div className="flex items-center">
                                    <span className="w-24 text-gray-600 font-bold whitespace-nowrap">본인 연락처:</span>
