            ...
            <div className="relative z-10 w-full mt-auto pt-8 pb-6 border-t border-white/5">
                <div className="w-full max-w-6xl mx-auto px-4 flex flex-col items-center text-center space-y-3">
                    ...
                    <div className="flex items-center justify-center gap-3 flex-wrap">
                        ...
                        <span className="text-white/40 text-[11px]">|</span>
                        <button onClick={() => setShowRefundModal(true)} className="text-orange-300/80 text-[11px] font-bold hover:text-orange-300 transition-colors">교환·반품·환불 정책</button>
                    </div>
                    {showRefundModal && (
                        <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={() => setShowRefundModal(false)}>
                            <div className="bg-[#13131f] border border-white/10 rounded-2xl w-full max-w-lg max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                                <div className="sticky top-0 bg-[#13131f] border-b border-white/10 px-5 py-4 flex items-center justify-between">
                                    ...
                                    <button onClick={() => setShowRefundModal(false)} className="text-white/40 hover:text-white transition-colors"><span className="material-symbols-outlined">close</span></button>
                                </div>
                                <div className="px-5 py-5 space-y-5 text-xs text-white/60 leading-relaxed">
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-1 list-none">
                                            ...
                                            <li>③ 위약금 10% 제외 후 부분 환불 (프로필카드 2회 이상 수령 시)</li>
                                            <li>④ 회사 귀책사유에 의한 결제 오류·서비스 중단: 전액 환불</li>
                                        </ul>
                                    </div>
                                    <hr className="border-white/10" />
                                    <div>
