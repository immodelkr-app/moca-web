        ...
        >
            ...
            <div onClick={(e) => e.stopPropagation()}>
                <button
                    ...
                    className={`w-full flex items-center justify-center gap-1.5 py-2.5 px-2 rounded-full active:scale-[0.98] transition-all cursor-pointer font-black text-[12px] leading-none border ${
                        canViewTrend
                            ? 'bg-[#F3E8FF] text-[#7C3AED] border-[#E8E0FA]'
                            : 'bg-[#F3F0FA] text-[#9CA3AF] border-[#E8E0FA]'
                    }`}
                >
...
const AgencyDirectory = () => {
    ...
    // ── GOLD 조건 충족 여부 (실버 페이월에 노출) + 조건 충족 시 자동 승급 ──────────
